...
gcc gl_scenes/models.c gl_scenes/mirror.c gl_scenes/yuv.c gl_scenes/square.c gl_scenes/teapot.c  RaspiCamControl.c RaspiCLI.c RaspiPreview.c RaspiCommonSettings.c RaspiHelpers.c RaspiStill.c  RaspiTex.c RaspiTexUtil.c tga.c $INCS $LIBS
