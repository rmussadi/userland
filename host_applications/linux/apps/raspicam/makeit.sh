...
gcc  gl_scenes/yuv.c gl_scenes/square.c RaspiCamControl.c RaspiCLI.c RaspiCommonSettings.c RaspiHelpers.c RaspiStill.c RaspiTex.c RaspiTexUtil.c tga.c $INCS $LIBS
